...
// TODO : WiFi connection: SSID and Password
const char* ssid = "YOUR_WIFI_SSID";
const char* password = "YOUR_WIFI_PASSWORD";

// MQTT server params: server, port, user, password, and unique clientid
const char* mqtt_server = "m21.cloudmqtt.com";
const int mqtt_port = 16036; 
const char *mqtt_user = "YOUR_MQTT_USER";
const char *mqtt_pass = "YOUR_MQTT_PASSWORD";
const char *mqtt_topic = "GetStuff";            // prefix with your initials, so you don't interference with your fellow participants
